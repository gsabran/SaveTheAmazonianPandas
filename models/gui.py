...
class GuiNet(Model):
    def __init__(self, weather_model, data, model=None, n_gpus=-1,test_time_augmentation=False):
        self.weather_model = weather_model
        super(GuiNet, self).__init__(data, model=model, n_gpus=n_gpus,test_time_augmentation=test_time_augmentation)
