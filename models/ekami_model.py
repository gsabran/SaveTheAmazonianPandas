...
class AmazonKerasClassifier(Model):
    def create_base_model(self):
        ...
        self.model.add_conv_layer(self.img_size)
        self.model.add_flatten_layer()
        self.model.add_ann_layer(NUM_WEATHER + NUM_TAGS)

    def add_conv_layer(self, img_size=(32, 32), img_channels=3):
        self.model.add(BatchNormalization(input_shape=(img_size[0], image_size[1], img_channels)))
