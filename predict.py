...
if __name__ == "__main__":
	with K.get_session():
		...
		parser.add_argument("--training-files", default="train/training-files.csv", help="Files to use for training", type=str)
		parser.add_argument("--validation-files", default="train/validation-files.csv", help="Files to use for validation", type=str)
		args = vars(parser.parse_args())
		print("args", args)

		with open(args["training_files"]) as f_training_files, open(args["validation_files"]) as f_validation_files:
		...
		if args["thresholds"] is not None:
			...
			with open(args["validation_files"]) as f_validation_files:
